...
| ---  | --- | --- | --- |
| [User](User.md) | [givenName](givenName.md) | range | [GivenName](GivenName.md) |
...
* [https://wiki.cdisc.org/display/PUB/GivenName](https://wiki.cdisc.org/display/PUB/GivenName)
...
see_also:
- https://wiki.cdisc.org/display/PUB/GivenName
rank: 1000
slots:
- content
slot_usage:

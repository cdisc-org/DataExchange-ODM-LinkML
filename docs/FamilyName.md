...
| ---  | --- | --- | --- |
| [User](User.md) | [familyName](familyName.md) | range | [FamilyName](FamilyName.md) |
...
* [https://wiki.cdisc.org/display/PUB/FamilyName](https://wiki.cdisc.org/display/PUB/FamilyName)
...
see_also:
- https://wiki.cdisc.org/display/PUB/FamilyName
rank: 1000
slots:
- content
slot_usage:

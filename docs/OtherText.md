...
| ---  | --- | --- | --- |
| [Address](Address.md) | [otherText](otherText.md) | range | [OtherText](OtherText.md) |
...
* [https://wiki.cdisc.org/display/PUB/OtherText](https://wiki.cdisc.org/display/PUB/OtherText)
...
see_also:
- https://wiki.cdisc.org/display/PUB/OtherText
rank: 1000
slots:
- content
slot_usage:
